...
impl Hat {
    ...
    pub fn new(phase_res: f32, z: f32, twin_cps: bool) -> Hat {
        let mut transducers: Vec<Point> = vec![];
        let n_transducers: usize = 16;
        let sep: f32 = 0.01126;
...
pub fn calc_transducer_phases(transducers: &Vec<Point>, control_points: &Vec<Point>, phase_res: f32) -> Vec<Complex<f32>> {
